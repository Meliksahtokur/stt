...
if __name__ == "__main__":
    ...
    stats_screen_path = os.path.join(project_root, 'ui', 'screens', 'statistics_screen.py')
    add_import_if_not_exists(
        stats_screen_path,
        "from kivy.uix.scrollview import ScrollView",
        r"from kivymd\.uix\.list import OneLineListItem" # After kivymd imports
    )
    ...
    # 4. src/utils.py eksik import - already handled based on chat context
    utils_path = os.path.join(project_root, 'src', 'utils.py')
    add_import_if_not_exists(
        utils_path,
        "from typing import Optional, Any, Dict, List", # All required typing imports
        r"import re" # After re import
    )
...
#
#[app:source.exclude.patterns@demo]
#images/hd/*
#
